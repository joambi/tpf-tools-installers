...
echo "This is the 'tpf-runner for the tpf-tools-advanced'."
echo "The 'tpf-runner' opens all preconfigured tpf-tools for your tpf-advanced session!"
...
echo "/Applications/tpf-tools-advanced/ardour-templates."
echo "------------------------------------------------------------"
...
echo -e "\033[1;32m       or open the tpf-advanced-basic.ardour session\033[0m"
...
echo -e "\033[1;32m       (e.g. tpf-advanced-basic.txt)\033[0m"
